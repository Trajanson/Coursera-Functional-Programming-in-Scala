...
$c_Lcalculator_Calculator$.prototype.evaluatateReference__T__sci_Map__D = (function(variableName, references) {
  var reference = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(variableName, references);
  return this.eval__Lcalculator_Expr__sci_Map__D(reference, $as_sci_Map(references.$$minus__O__sc_Map(variableName)))
});
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  if ($is_Lcalculator_Literal(expr)) {
    ...
    var name = x3.name$2;
    return this.evaluatateReference__T__sci_Map__D(name, references)
...
$c_Lcalculator_Polynomial$.prototype.computeDeltaOnFly__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__D = (function(a, b, c) {
  var aCalculated = $uD(a.apply__O());
  var bCalculated = $uD(b.apply__O());
  var cCalculated = $uD(c.apply__O());
  return ((bCalculated * bCalculated) - ((4 * aCalculated) * cCalculated))
});
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2, delta$1) {
    return (function() {
      return $m_Lcalculator_Polynomial$().computeSolutionOnFly__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__sci_Set(a$2, b$2, c$2, delta$1)
    })
  })(a, b, c, delta));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_Polynomial$.prototype.computeSolutionOnFly__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__sci_Set = (function(a, b, c, delta) {
  var aCalculated = $uD(a.apply__O());
  var bCalculated = $uD(b.apply__O());
  $uD(c.apply__O());
  var deltaComputed = $uD(delta.apply__O());
  var twoTimesA = (2 * aCalculated);
  var sqrtDelta = $uD($g["Math"]["sqrt"](deltaComputed));
  var first = (((-bCalculated) + sqrtDelta) / twoTimesA);
  var second = (((-bCalculated) - sqrtDelta) / twoTimesA);
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      return $m_Lcalculator_Polynomial$().computeDeltaOnFly__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__D(a$1, b$1, c$1)
    })
  })(a, b, c));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(tweetText$1) {
    return (function() {
      return $m_Lcalculator_TweetLength$().calculator$TweetLength$$usedChars$1__Lcalculator_Signal__I(tweetText$1)
    })
  })(tweetText));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$colorPicker$1__Lcalculator_Signal__T = (function(remainingCharsCount$1) {
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return $m_Lcalculator_TweetLength$().calculator$TweetLength$$colorPicker$1__Lcalculator_Signal__T(remainingCharsCount$1)
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$usedChars$1__Lcalculator_Signal__I = (function(tweetText$1) {
  var text = $as_T(tweetText$1.apply__O());
  var remainingChars = this.tweetLength__p1__T__I(text);
  return ((140 - remainingChars) | 0)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T2__T2 = (function(x$1) {
  if ((x$1 !== null)) {
    ...
    var value = new $c_Lcalculator_Signal().init___F0(expr);
    return new $c_T2().init___O__O(variable, value)
  } else {
